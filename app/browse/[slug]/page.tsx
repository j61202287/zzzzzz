...
export default function DiscoverResult() {
  ...
  return (
    <div className="lg:w-[85%] w-[95%] mx-auto py-20">
      <h1 className=" uppercase  mask-[linear-gradient(to_bottom,black_0%,transparent_85%)] lg:text-7xl text-4xl font-bold text-red-700  translate-y-1  tracking-tighter pointer-events-none text-center ">
