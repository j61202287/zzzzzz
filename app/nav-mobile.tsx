...
export default function MobileNavBar() {
  ...
  return (
    <div className="fixed   inset-x-0 flex justify-center items-center p-4 z-40  bottom-0 bg-background/80 backdrop-blur-lg rounded-t-2xl border-t  gap-8  w-full lg:hidden text-muted-foreground">
      <button
