...
export default function DiscoverMovie() {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
    useGetDiscoverInfinite<MovieTypes>({
      ...
      params: {
        ...
        ...(selectedNetwork && { with_companies: selectedNetwork }),
  ...
  const selectedNetworkLabel = productionCompanies.find(
    (network) => network.id === selectedNetwork,
  )?.name;
  //FILTERS
  const selectedGenreLabels = movieGenres.filter((genre) =>
  ...
  return (
    <div className=" py-15 space-y-2 mx-auto lg:w-[85%] w-[95%] ">
            ...
            <div className="overflow-auto custom-scrollbar space-y-3">
              <div className="lg:p-4 p-2 lg:space-y-3 space-y-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {movieGenres
                    .slice(0, expandGenre ? movieGenres.length : 5)
                    .map((genre) => (
                      <Button
                        key={genre.id}
                        size="xl"
              ...
              <div className=" lg:p-4 p-2 lg:space-y-3 space-y-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {productionCompanies
                    .slice(0, expandCompanies ? productionCompanies.length : 4)
                    .map((network) => (
                      <Button
                        variant={
      ...
      <h1 className=" uppercase text-end  mask-[linear-gradient(to_bottom,black_0%,transparent_85%)] lg:text-6xl text-5xl font-bold text-red-700  translate-y-3 ">
        MOVIES
      </h1>
      <div
